...
from PyQt5.QtWidgets import QApplication, QListWidgetItem, QMainWindow, \
 QLabel,QPushButton,QLineEdit,QComboBox,QMenu,QAction,qApp,\
     QListWidget,QListWidgetItem,QShortcut, QSystemTrayIcon,QDialog,QMessageBox
from PyQt5.QtCore import  Qt,QRectF,Qt
from PyQt5.QtGui import QFont,QPainterPath,QRegion,QKeySequence,QIcon,QFontDatabase
import sqlite3
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.LangClicked.setFont(QFont('asi',10))
        ...
        self.SettingsButton.setFont(QFont('asi',13))
